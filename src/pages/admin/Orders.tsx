            ...
            <Box sx={{ mt: 2 }}>
              ...
              >
                ...
                <Box>
                  ...
                  <Typography variant="h6">€{selectedOrder.total.toLocaleString('fr-FR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</Typography>
                </Box>
              </Box>
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell align="right" sx={{ fontWeight: 600 }}>
                        €{selectedOrder.total.toLocaleString('fr-FR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                      </TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
